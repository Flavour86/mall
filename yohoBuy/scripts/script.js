...
if ( getMobileOS.device === 'iPhone' ) {
$.ajax({
				type:"get",
				url:"http://play.91.com/index.php/Inc/entry/id/165",
				dataType:"jsonp",
				scriptCharset:'utf-8',
				success:function(result){
					...
					for(var i=0;i<result["data"].length;i++) {
						appList+='<li><a href="'+result["data"][i]["url"]+'" target="_blank"><img src="'+result["data"][i]["icon_80"]+'" alt="'+result["data"][i]["name"]+'" /><span>'+result["data"][i]["name"]+'</span></a></li>';
						
            }  
					$(".scroll-soft").append(appList);
				
				},
			});
}else if ( getMobileOS.device === 'Android' ){}



$(document).ready(function() {
	var $lBtn =$(".h-link-l") , $rBtn=$(".h-link-r") , $lBox = $(".pro-box") , $rBox = $(".nav-box");
	$lBtn.on('click',function(){ $rBox.removeClass("show-box");$lBox.toggleClass("show-box") });
	$rBtn.on('click',function(){ $lBox.removeClass("show-box");$rBox.toggleClass("show-box") });
})